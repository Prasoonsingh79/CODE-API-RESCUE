...
import { Code2, LogOut, User, Compass, LayoutDashboard, Trophy, Github } from 'lucide-react';
  ...
  return (
    <header className="navbar">
      ...
      <div className="nav-links">
        <Link to="/explore" className="nav-link" style={{display: 'flex', alignItems: 'center', gap: '0.4rem'}}><Compass size={18}/> Explore</Link>
        <Link to="/github" className="nav-link" style={{display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#10b981'}}><Github size={18}/> Sync GitHub</Link>
        <Link to="/leaderboard" className="nav-link" style={{display: 'flex', alignItems: 'center', gap: '0.4rem'}}><Trophy size={18}/> Leaderboard</Link>
        
        {user ? (
          <>
            <Link to="/workspace" className="nav-link" style={{display: 'flex', alignItems: 'center', gap: '0.4rem'}}><LayoutDashboard size={18}/> My Workspace</Link>
      ...
      <div className="app-container">
        ...
        <main>
          <Routes>
            ...
            <Route path="/explore" element={user ? <Explore /> : <Navigate to="/" replace />} />
            <Route path="/github" element={user ? <GithubScanner /> : <Navigate to="/" replace />} />
